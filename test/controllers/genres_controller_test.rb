...
class GenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create genre" do
    assert_difference('Genre.count') do
      post genres_url, params: { genre: { name: @genre.name, novel_word_ratio: @genre.novel_word_ratio, total_word_count: @genre.total_word_count } }
    end
  ...
  test "should update genre" do
    patch genre_url(@genre), params: { genre: { name: @genre.name, novel_word_ratio: @genre.novel_word_ratio, total_word_count: @genre.total_word_count } }
